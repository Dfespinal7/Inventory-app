    ...
    <div className="p-8 h-screen bg-gray-300">
        ...
        <div className=" w-[50%]  flex flex-col justify-center items-center gap-2">
            ...
            <div className="rounded-lg border-gray-400  p-8 h-[50%] w-[50%] flex justify-center items-center">
                <form action="" className="flex flex-col gap-3 h-full w-full justify-between items-center  ">
                    <input type="text" placeholder="Enter your name" className="border px-2 py-1 rounded-lg border-gray-400 w-full shadow-md"/>
                    <input type="text" placeholder="Enter your email"  className="border px-2 py-1 rounded-lg border-gray-400 w-full shadow-md"/>
                    <input type="text" placeholder="Enter your password" className="border px-2 py-1 rounded-lg border-gray-400 w-full shadow-md" />
                    <input type="text" placeholder="Enter your phone number " className="border px-2 py-1 rounded-lg border-gray-400 w-full shadow-md"/>
